...
1. [ホーム] リボンで、**[OneLake データ ハブ] > [Power BI セマンティック モデル]** を選択します。

1. **[OneLake データ ハブ]** ウィンドウの **[マイ ワークスペース]** で **[売り上げ分析]** セマンティック モデルを選んでから、**[接続]** を選択するか、ダブルクリックしてセマンティック モデルを読み込みます。
