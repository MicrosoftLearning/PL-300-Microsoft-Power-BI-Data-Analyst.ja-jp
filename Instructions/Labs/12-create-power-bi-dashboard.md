...
1. **[インポート] > [レポート]、[改ページ対応レポート]、または [ブック] > [このコンピューターから]** を選択します。
...
1. **[概要]** ページで、**[年]** スライサーを **FY2020** に設定します。
    ...
    ![画像 4](Linked_image_Files/12-create-power-bi-dashboard_image17.png)
...
1. プロンプトが表示されたら、ドロップダウン メニューから **[売上モニタリング]** を選択し、**[固定]** を選択します。
...
2. **[画像タイルの追加]** ペインの **[URL]** ボックスにテキスト ファイルの URL を貼り付けて、**[適用]** をクリックします。
...
1. Power BI Desktop ファイルの **[データ]** ペインで、**Sales** テーブルを右クリックして **[更新] > [データ]** を選択します。
...
3. **2020 Jun** の列があることにも注目してください。
    ...
    ![画像 33](Linked_image_Files/12-create-power-bi-dashboard_image50.png)
