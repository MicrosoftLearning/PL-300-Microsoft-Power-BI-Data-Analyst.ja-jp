...
# <a name="perform-data-analysis-in-power-bi"></a>**Power BI でデータ分析を実行する**
...
4. **[開く]** ウィンドウで、**D:\PL300\Labs\08-perform-data-analysis-in-power-bi-desktop\Starter** フォルダーに移動します。
